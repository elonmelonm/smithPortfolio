...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs
        .sendForm('service_6zdpjyp', 'template_qzwrzsl', form.current, {
            publicKey: 'ShfEbM7aGAa906G90',
        })
        e.target.reset();
    };
            ...
            <div className="contact__content">
                ...
                <form ref={form} onSubmit={sendEmail} className="contact__form">
                    <div className="contact__form-div">
                        <div className="label contact__form-tag">Name</div>
                        <input type="text" name='name' className="contact__form-input" placeholder="Insert your name" />
                    </div>

                    <div className="contact__form-div">
                        <div className="label contact__form-tag">Mail</div>
